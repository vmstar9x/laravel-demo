        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="block-fluid">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.product.postAdd') }}">
                        {!! csrf_field() !!}
                        <div class="row-form">
                            <div class="span3">Product name:</div>
                            <div class="span9">
                                <input type="text" placeholder="some text value..." name="product_name" value=""/>
                        ...
                        <div class="row-form">
                            ...
                            <div class="span9">
                                <input type="number" placeholder="some number value..." name="product_price" value=""/>
                        ...
                        <div class="row-form">
                            ...
                            <div class="span9">
                                <textarea name="product_description" id="" cols="30" rows="10" placeholder="some text value..."></textarea>
